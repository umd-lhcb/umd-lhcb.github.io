{
  ...
  autoprefixer-rails = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0d567s20z3hxmjpmpqzgn1vhwvqjlh4hhw0awwcmmgdfiijiv5y9";
      type = "gem";
    };
    version = "9.8.6";
  };
  ...
  css_press = {
    dependencies = ["csspool-st" "json"];
    groups = ["default" "jekyll_plugins"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "18fbyrrb31zr8c6mviz848w6zb8c6wrrzk3pkw2cdlkg53wiq9li";
      type = "gem";
    };
    version = "0.3.2";
  };
  csspool-st = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0k788n9bdn3z9d6qk7nhz1lg332gc1scrb4bn5pncyq5h28p7rym";
      type = "gem";
    };
    version = "3.1.2";
  };
  ...
  html_press = {
    dependencies = ["htmlentities" "multi_css" "multi_js"];
    groups = ["default" "jekyll_plugins"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0ljzaylziq9b060w791ziq7aglr0pzqz1gl5pibmi46fxfff24n4";
      type = "gem";
    };
    version = "0.8.2";
  };
  ...
  jekyll-autoprefixer = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "09zysc8491ra9ar9cv5jfwv7r1hrkqc7kydz7zrykk511vw7xvks";
      type = "gem";
    };
    version = "1.0.2";
  };
  ...
  jekyll-scholar = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0gwl57571adn6pqp3w3m610ggq00x3vzlahxbw7wa7sqvjdm3k60";
      type = "gem";
    };
    version = "6.8.0";
  };
  ...
  multi_css = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0g830554xkndaxvf6qj166mllsx2v1mq1mgkas319856k6n32wbn";
      type = "gem";
    };
    version = "0.1.0";
  };
  multi_js = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1bjyqs4a52vzfl7viqmqqhspjlcsz7a7ghjcbr0jny08c7ay6j6f";
      type = "gem";
    };
    version = "0.1.0";
  };
  ...
  octopress-minify-html = {
    dependencies = ["html_press" "jekyll" "octopress-hooks"];
    groups = ["jekyll_plugins"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1mmrj8mn6v9v70p4i8yblz96yxfkkw1a85djm354syvgw4r614b5";
      type = "gem";
    };
    version = "1.3.1";
  };
